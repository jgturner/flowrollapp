                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-shrink-0 w-20 h-20 md:w-24 md:h-24">
                        {competition.podium_photo_url ? (
                          <Image src={competition.podium_photo_url} alt="Podium photo" width={96} height={96} className="rounded-full object-cover w-full h-full" />
                        ) : (
